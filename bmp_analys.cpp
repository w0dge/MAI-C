...
uint32_t** analysis(String pathToFile) // сделать своей функцией, которую можно реализовать в коде поиска изображения
{
    FILE* pFile = fopen(pathToFile, "rb"); //cat_grey mouse // реализовать ввод с клавы
